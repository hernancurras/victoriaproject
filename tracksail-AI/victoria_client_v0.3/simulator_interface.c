...
{
     int sockfd;
     //struct sockaddr_in serv_addr;			REMOVIDO por Hernan, no está siendo utilizada
     stop_running=0;
     ...
     //serv_addr.sin_family = AF_INET;			REMOVIDO por Hernan, no está siendo utilizada
     //serv_addr.sin_addr.s_addr = inet_addr(SERVER);	REMOVIDO por Hernan, no está siendo utilizada
     //serv_addr.sin_port = htons(PORT);			REMOVIDO por Hernan, no está siendo utilizada
